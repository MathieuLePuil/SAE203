...
<body>
    ...
    <main>
        ...
        <section id="what-atp">
            ...
            <div class="text-white" id="what-atp-div">
                <p>L'ATP Tour est composé de tournois de plusieurs catégories, chacune caractérisée par des dotations et des gains en points spécifiques. Le calendrier du circuit principal débute la première semaine de janvier et se termine à la fin du mois de novembre. En voici le détail par ordre décroissant d'importance : <br /><br /> • <b>Grand Chelem</b> : au nombre de quatre (Open d'Australie, Internationaux de France, Wimbledon et US Open), les tournois du Grand Chelem attribuent des points ATP mais sont organisés par la Fédération internationale de tennis (ITF) et les fédérations nationales concernées. <br /> • <b>Masters</b> : il constitue le dernier tournoi majeur de la saison tennistique depuis 1970. Organisé à Turin depuis 2021, il met aux prises les huit meilleurs joueurs et les huit meilleures équipes du monde. <br /> • <b>Masters</b> 1000 : série de neuf tournois qui se déroulent en Europe, en Asie, en Amérique, mis en place en 1990 pour réunir les meilleurs joueurs sur différents types de surfaces. Moins prestigieux que les Grands Chelems, ils constituent la deuxième catégorie dans la « hiérarchie » des tournois. <br /> • <b>ATP 500</b> : 13 tournois sont classés dans cette catégorie qui est moins prestigieuse que les Masters 1000 mais plus importante que les ATP 250. <br /> • <b>ATP 250</b> : cette catégorie comprend chaque année environ 40 tournois. Ce sont les moins prestigieux dans la hiérarchie de l'ATP Tour.</p>
            </div>
